...
public class CityListAdapterOld extends RecyclerView.Adapter<CityListAdapterOld.CityListViewHolder> {
    ...
    public CityListAdapterOld(Context context, List<WeatherReportModel> citiesList) {
